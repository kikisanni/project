...
import quiz from "../../../assets/assessment.jpg";
...
function EmotionsAssessmentMain({ user }: MainProps) {
...
//   const modalContent = () => {
//     if (existingResults?.hearts === 0 && existingResults?.completed !== 2 || existingResults?.hearts === 1 && existingResults?.completed !== 2) {
//       return (
//         <div>
//           <h2 className="text-xl font-semibold mb-2">Out of Hearts!</h2>
//           <p className="mb-4">
//             You need 2 or more hearts to start the quiz. Go back to the previous category to
//             gather more hearts!
//           </p>
//         </div>
//       );
...
//       window.location.href = "/quiz-1-medium";
//     }
//   };
...
//   };
  ...
  const instructions = [
    "Make sure you have watched the lessons before attempting this assessment.",
    ...
    <div className="container mx-auto mt-10 font-serif">
      <div className="text-center">
        <h2 className="mb-3 font-bold underline underline-offset-8 decoration-blue-400 text-3xl">
          {" "}
          Assessment 3: Feelings and Emotions - Hard
        </h2>
        <h2>Start this assessment, win Gesto points at the end!</h2>
      </div>
...
export default EmotionsAssessmentMain;
