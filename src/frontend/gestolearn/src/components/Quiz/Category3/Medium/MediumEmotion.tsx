...
function MediumEmotions({ user }: MediumQuizProps) {
  ...
  const modalContent = () => {
    if (existingResults?.hearts === 0 && existingResults?.completed !== 6 || existingResults?.hearts === 1 && existingResults?.completed !== 6) {
      return (
        <div>
      ...
      window.location.href = "/quiz-3-medium";
    }
  };
    ...
    <div className="container mx-auto mt-10 font-serif">
      <div className="text-center">
        <h2 className="mb-3 font-bold underline underline-offset-8 decoration-blue-400 text-3xl">
          {" "}
          Quiz 3: Feelings and Emotions - Medium
        </h2>
