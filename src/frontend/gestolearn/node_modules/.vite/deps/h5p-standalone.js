...
var require_main_bundle = __commonJS({
  "node_modules/h5p-standalone/dist/main.bundle.js"(exports, module) {
    !function(e, n) {
      ...
      var e = { 633: (e2) => {
        function n2(e3, n3) {
          var t2 = e3.length, r2 = new Array(t2), o = {}, i = t2, a = function(e4) {
            for (var n4 = /* @__PURE__ */ new Map(), t3 = 0, r3 = e4.length; t3 < r3; t3++) {
              var o2 = e4[t3];
              n4.has(o2[0]) || n4.set(o2[0], /* @__PURE__ */ new Set()), n4.has(o2[1]) || n4.set(o2[1], /* @__PURE__ */ new Set()), n4.get(o2[0]).add(o2[1]);
            }
            return n4;
          }(n3), s = function(e4) {
            for (var n4 = /* @__PURE__ */ new Map(), t3 = 0, r3 = e4.length; t3 < r3; t3++)
          ...
          function c(e4, n4, i2) {
            ...
            if (!o[n4]) {
              o[n4] = true;
              var u = a.get(e4) || /* @__PURE__ */ new Set();
        ...
        e2.exports = function(e3) {
          return n2(function(e4) {
            for (var n3 = /* @__PURE__ */ new Set(), t2 = 0, r2 = e4.length; t2 < r2; t2++) {
              var o = e4[t2];
      ...
      return (() => {
        ...
        function o(e3) {
          if ((e3 = e3.trim()).match(/^([a-z0-9]+:\/\/|www.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/i))
            return e3;
          if (e3.startsWith("//"))
        ...
        function i(t2, r2) {
          return e2(this, void 0, void 0, function() {
            return n2(this, function(e3) {
              switch (e3.label) {
                case 0:
                  return r2 || (r2 = { credentials: "include" }), [4, fetch(t2, r2)];
                case 1:
        ...
        function l(e3) {
          ...
          return l.apply(void 0, function(e4, n4, t3) {
          ...
          function e3(e4, n3) {
            ...
            return this.prepareH5PEnvironment(r2, n3).then(function(o2) {
              ...
              return t2.renderPlayerFrame({ anchorElement: e4, contentId: r2, embedType: i2, H5PIntegration: o2 }).then(function() {
                return (void 0 === n3.preventH5PInit || n3.preventH5PInit) && ("function" == typeof window.H5P.init && window.H5P.init(), window.H5P.preventInit = false), r2;
              });
            });
          }
          return e3.prototype.renderPlayerFrame = function(e4) {
            ...
            return d(this, void 0, void 0, function() {
              ...
              return p(this, function(p2) {
                switch (p2.label) {
                  case 0:
                    return a2 = this.getH5PPaths(n3), s2 = a2.h5pJsonPath, c2 = a2.contentJsonPath, d2 = a2.librariesPath, [4, i("".concat(s2, "/h5p.json"), null == n3 ? void 0 : n3.assetsRequestFetchOptions)];
                  case 1:
                    return f2 = p2.sent(), h2 = this, [4, this.libraryFolderNameIncludesVersion(d2, f2.preloadedDependencies[0], null == n3 ? void 0 : n3.assetsRequestFetchOptions)];
                  case 2:
                    return h2.libraryFolderContainsVersion = p2.sent(), [4, i("".concat(c2, "/content.json"), null == n3 ? void 0 : n3.assetsRequestFetchOptions)];
                  case 3:
                    return m2 = p2.sent(), [4, this.findMainLibrary(f2, d2)];
                  case 4:
                    return y = p2.sent(), [4, this.findAllDependencies(f2, d2)];
                  case 5:
                    return b = p2.sent(), v = this.sortDependencies(b, d2), w = v.styles, g = v.scripts, C = { baseUrl: window.location.origin, url: "", contents: {}, saveFreq: false, postUserStatistics: false, ajax: {}, l10n: { H5P: { fullscreen: "Fullscreen", disableFullscreen: "Disable fullscreen", download: "Download", copyrights: "Rights of use", embed: "Embed", size: "Size", showAdvanced: "Show advanced", hideAdvanced: "Hide advanced", advancedHelp: "Include this script on your website if you want dynamic sizing of the embedded content:", copyrightInformation: "Rights of use", close: "Close", title: "Title", author: "Author", year: "Year", source: "Source", license: "License", thumbnail: "Thumbnail", noCopyrights: "No copyright information available for this content.", reuse: "Reuse", reuseContent: "Reuse Content", reuseDescription: "Reuse this content.", downloadDescription: "Download this content as a H5P file.", copyrightsDescription: "View copyright information for this content.", embedDescription: "View the embed code for this content.", h5pDescription: "Visit H5P.org to check out more cool content.", contentChanged: "This content has changed since you last used it.", startingOver: "You'll be starting over.", by: "by", showMore: "Show more", showLess: "Show less", subLevel: "Sublevel", confirmDialogHeader: "Confirm action", confirmDialogBody: "Please confirm that you wish to proceed. This action is not reversible.", cancelLabel: "Cancel", confirmLabel: "Confirm", licenseU: "Undisclosed", licenseCCBY: "Attribution", licenseCCBYSA: "Attribution-ShareAlike", licenseCCBYND: "Attribution-NoDerivs", licenseCCBYNC: "Attribution-NonCommercial", licenseCCBYNCSA: "Attribution-NonCommercial-ShareAlike", licenseCCBYNCND: "Attribution-NonCommercial-NoDerivs", licenseCC40: "4.0 International", licenseCC30: "3.0 Unported", licenseCC25: "2.5 Generic", licenseCC20: "2.0 Generic", licenseCC10: "1.0 Generic", licenseGPL: "General Public License", licenseV3: "Version 3", licenseV2: "Version 2", licenseV1: "Version 1", licensePD: "Public Domain", licenseCC010: "CC0 1.0 Universal (CC0 1.0) Public Domain Dedication", licensePDM: "Public Domain Mark", licenseC: "Copyright", contentType: "Content Type", licenseExtras: "License Extras", changes: "Changelog", contentCopied: "Content is copied to the clipboard", connectionLost: "Connection lost. Results will be stored and sent when you regain connection.", connectionReestablished: "Connection reestablished.", resubmitScores: "Attempting to submit stored results.", offlineDialogHeader: "Your connection to the server was lost", offlineDialogBody: "We were unable to send information about your completion of this task. Please check your internet connection.", offlineDialogRetryMessage: "Retrying in :num....", offlineDialogRetryButtonLabel: "Retry now", offlineSuccessfulSubmit: "Successfully submitted results." } } }, window && window.H5PIntegration && (C = l(C, window.H5PIntegration)), P = [o("./frame.bundle.js")], D = [o("./styles/h5p.css")], n3.frameJs && (P = [o(n3.frameJs)]), n3.frameCss && (D = [o(n3.frameCss)]), C.core ? (C.core.styles = u(C.core.styles, D), C.core.scripts = u(C.core.scripts, P)) : C.core = { styles: D, scripts: P }, C.url = e4, C.urlLibraries = d2, C.postUserStatistics = !!n3.postUserStatistics, n3.saveFreq && "number" == typeof n3.saveFreq && (C.saveFreq = n3.saveFreq), n3.user && (C.user = n3.user), (null === (t2 = n3.ajax) || void 0 === t2 ? void 0 : t2.contentUserDataUrl) && (C.ajax.contentUserData = n3.ajax.contentUserDataUrl), (null === (r2 = n3.ajax) || void 0 === r2 ? void 0 : r2.setFinishedUrl) && (C.ajax.setFinished = n3.ajax.setFinishedUrl), n3.translations && (C.l10n = l(C.l10n, n3.translations)), n3.customCss && "string" == typeof n3.customCss && (n3.customCss = [n3.customCss]), n3.customJs && "string" == typeof n3.customJs && (n3.customJs = [n3.customJs]), w = w.concat((n3.customCss || []).map(function(e5) {
                      return o(e5);
                    })), g = g.concat((n3.customJs || []).map(function(e5) {
                      return o(e5);
                    })), F = { copyright: !!n3.copyright, embed: !!n3.embed, export: !!n3.export, frame: !!n3.frame, icon: !!n3.icon, copy: !!n3.copy }, N = "".concat(y.machineName, " "), y.majorVersion && (N += y.majorVersion), y.minorVersion && (N += ".".concat(y.minorVersion)), C.contents || (C.contents = {}), (null == n3 ? void 0 : n3.metadata) || (n3.metadata = { title: n3.title ? n3.title : "", license: "U" }), C.contents["cid-".concat(e4)] = { library: N, title: n3.title ? n3.title : "", url: s2, contentUrl: c2, jsonContent: JSON.stringify(m2), styles: w, scripts: g, fullScreen: !!n3.fullScreen, exportUrl: n3.downloadUrl ? o(n3.downloadUrl) : void 0, embedCode: n3.embedCode ? n3.embedCode : "", resizeCode: n3.resizeCode ? n3.resizeCode : "", displayOptions: F, contentUserData: n3.contentUserData, metadata: n3.metadata }, n3.xAPIObjectIRI && (C.contents["cid-".concat(e4)].url = n3.xAPIObjectIRI), window.H5PIntegration = C, [2, C];
                }
              });
            });
            ...
            return this.libraryFolderContainsVersion && (void 0 !== e4.majorVersion && (n3 += "-".concat(e4.majorVersion)), void 0 !== e4.minorVersion && (n3 += ".".concat(e4.minorVersion))), n3;
          }, e3.prototype.findMainLibrary = function(e4, n3) {
            return d(this, void 0, void 0, function() {
              var t2, r2;
              return p(this, function(o2) {
                return t2 = e4.preloadedDependencies.find(function(n4) {
                  return n4.machineName === e4.mainLibrary;
                }), r2 = this.libraryToFolderName(t2), [2, i("".concat(n3, "/").concat(r2, "/library.json"))];
              });
            });
          }, e3.prototype.findAllDependencies = function(e4, n3) {
            return d(this, void 0, void 0, function() {
              var t2, r2 = this;
              return p(this, function(o2) {
                return t2 = e4.preloadedDependencies.map(function(e5) {
                  return r2.libraryToFolderName(e5);
                }), [2, this.loadDependencies(t2, [], n3)];
              });
            });
          }, e3.prototype.loadDependencies = function(e4, n3, t2) {
            return d(this, void 0, void 0, function() {
              var r2, o2, i2, a2, s2 = this;
              return p(this, function(c2) {
                switch (c2.label) {
                  case 0:
                    return r2 = n3, o2 = [], i2 = e4.map(function(e5) {
                      return s2.findLibraryDependencies(e5, t2);
                    }), [4, Promise.all(i2)];
                  case 1:
                    return (a2 = c2.sent()).forEach(function(e5) {
                      r2.push(e5), e5.dependencies.forEach(function(e6) {
                        var n4 = r2.find(function(n5) {
                          return n5.libraryFolderName === e6;
                        }), t3 = a2.find(function(n5) {
                          return n5.libraryFolderName === e6;
                        });
                        n4 || t3 || o2.push(e6);
                      });
                    }), o2.length > 0 ? [2, this.loadDependencies(o2, r2, t2)] : [2, r2];
                }
              });
            });
          }, e3.prototype.findLibraryDependencies = function(e4, n3) {
            return d(this, void 0, void 0, function() {
              var t2, r2, o2 = this;
              return p(this, function(a2) {
                switch (a2.label) {
                  case 0:
                    return [4, i("".concat(n3, "/").concat(e4, "/library.json"))];
                  case 1:
                    return t2 = a2.sent(), r2 = [], t2.preloadedDependencies && (r2 = t2.preloadedDependencies.map(function(e5) {
                      return o2.libraryToFolderName(e5);
                    })), [2, { libraryFolderName: e4, dependencies: r2, preloadedCss: t2.preloadedCss, preloadedJs: t2.preloadedJs }];
                }
              });
            });
            ...
            e4.forEach(function(e5) {
              0 === e5.dependencies.length && t2.push([e5.libraryFolderName]), e5.dependencies.forEach(function(n4) {
...
export default require_main_bundle();
//# sourceMappingURL=h5p-standalone.js.map
